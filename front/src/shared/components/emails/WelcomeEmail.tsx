...
const credentialsBox = { backgroundColor: "#f8f8f8", padding: "20px", borderRadius: "8px", margin: "25px 0", borderLeft: "4px solid #f97316" };
...
const ctaButton = { display: "inline-block", padding: "14px 28px", fontSize: "16px", color: "#ffffff", backgroundColor: "#f97316", textDecoration: "none", borderRadius: "8px", fontWeight: "bold" as const };
