      ...
      <Container style={container}>
        ...
        <Section style={content}>
          ...
          <Section style={credentialsBox}>
            <Heading as="h2" style={h2}>
              Tus datos para el primer acceso:
            </Heading>
            <Text style={credentialText}>
              <strong>Teléfono:</strong> {managerName}
              <br />
              <span>o</span>
              <br />
            ...
            <Text style={credentialText}>
              ...
              <span style={password}>{temporaryPassword}</span>
            </Text>
          </Section>

          <Text style={paragraph}>
            Por seguridad, te recomendamos iniciar sesión y cambiar tu
        ...
        <Section style={footer}>
          <Text style={footerText}>
            ...
            <br />
            &copy; {new Date().getFullYear()} CheCancha. Todos los derechos
            reservados.
          </Text>
        </Section>
      </Container>
...
const header = {
  backgroundColor: "#fe4321", //brand-orange
  padding: "20px",
...
const credentialsBox = {
  ...
  borderRadius: "8px",
  margin: "25px 0",
  borderLeft: "4px solid #fe4321", //brand-orange
};
const credentialText = { margin: "10px 0" };
const password = {
  fontSize: "24px",
  fontWeight: "bold" as const,
  color: "#fe4321", //brand-orange
