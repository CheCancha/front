...
const ctaButton = { display: "inline-block", padding: "12px 24px", fontSize: "16px", color: "white", backgroundColor: "#fe4321", textDecoration: "none", borderRadius: "5px", fontWeight: "bold" as const };
