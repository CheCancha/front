        ...
        <div className="relative isolate overflow-hidden bg-foreground px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
            ...
            <p className="mt-6 text-lg/8 text-pretty text-gray-300">
             Optimizá tu gestión, llená horarios vacíos y conectá con miles de nuevos jugadores. Somos tu aliado digital para crecer.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
              ...
              <Link href={routes.public.clubs} className="text-sm/6 font-semibold text-white hover:text-gray-100">
                Ver más
